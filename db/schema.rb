...
ActiveRecord::Schema[8.1].define(version: 2026_06_24_090002) do
  ...
  create_table "measurement_entries", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_measurement_entries_on_user_id"
  end
  ...
  add_foreign_key "measurement_entries", "users"
end
